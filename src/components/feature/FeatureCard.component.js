...
const FeatureCard = ({ data }) => {
  return (
    <motion.figure
      ...
      viewport={{ once: true }}
      className='p-6 bg-no-repeat bg-cover bg-center rounded-md shadow-md bg-blend-normal bg-black h-auto  lg:h-72 hover:bg-blend-multiply figure duration-1000 flex justify-center items-center relative'
      style={{
